...
function ChangeLangButton({ language }) {
  ...
  function changeLanguage() {
    var url = window.location.href.slice(
      0,
      window.location.href.lastIndexOf("c")
    );
    console.log(url);
    if (language == "cat"){
      navigate(
        `../exercises/${
          window.location.href[window.location.href.lastIndexOf("/") - 1]
        }/cast`
      ); navigate(0);}
    /*             window.location.href = window.location.href.replace("cat", "cast")
     */
    /*    window.location.href = window.location.href.replace("cast", "cat") */ else {
      navigate(
        `../exercises/${
          window.location.href[window.location.href.lastIndexOf("/") - 1]
        }/cat`
